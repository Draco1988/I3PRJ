...
# Date: Thu, 14 Dec 2017 12:40:45 GMT
#set_units -time ns
...
create_clock -name {ADC_SAR_2_theACLK(routed)} -period 541.66666666666663 -waveform {0 270.833333333333} [list [get_pins {ClockBlock/dclk_1}]]
...
create_generated_clock -name {ADC_SAR_2_theACLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 13 27} -nominal_period 541.66666666666663 [list [get_pins {ClockBlock/dclk_glb_1}]]
...
# Project: C:\Users\larsholm92\Documents\IKT\3. Semester\Projektgruppe16\I3PRJ\PSoC_SW_NOT_TESTED\DC-Motor-PWM.cydsn\DC-Motor-PWM.cyprj
# Date: Thu, 14 Dec 2017 12:40:30 GMT

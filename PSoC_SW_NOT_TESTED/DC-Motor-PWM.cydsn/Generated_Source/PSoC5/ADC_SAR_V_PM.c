...
*  The ADC_SAR_V_Sleep() routine saves the current component state,
...
*
* Global Variables:
*  ADC_SAR_V_backup - The structure field 'enableState' is modified
...
*  ADC_SAR_V_Sleep() was called. If the component was enabled before the
*  ADC_SAR_V_Sleep() function was called, the
*  ADC_SAR_V_Wakeup() function also re-enables the component.
*
* Parameters:
*  None.
*
...
*
* Global Variables:
*  ADC_SAR_V_backup - The structure field 'enableState' is used to

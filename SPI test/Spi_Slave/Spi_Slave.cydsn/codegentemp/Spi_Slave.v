...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("caf7cd68-39d3-42b0-a2f4-6bb2cabaf1f2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_1 UART_Slave (
        ...
        .rx_data(Net_32),
        .rx_clk(Net_33));
    defparam UART_Slave.Address1 = 0;
    defparam UART_Slave.Address2 = 0;
    defparam UART_Slave.EnIntRXInterrupt = 0;
    defparam UART_Slave.EnIntTXInterrupt = 0;
    defparam UART_Slave.FlowControl = 0;
    defparam UART_Slave.HalfDuplexEn = 0;
    defparam UART_Slave.HwTXEnSignal = 1;
    defparam UART_Slave.NumDataBits = 8;
    defparam UART_Slave.NumStopBits = 1;
    defparam UART_Slave.ParityType = 0;
    defparam UART_Slave.RXEnable = 1;
    defparam UART_Slave.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("ba2cab97-d1b7-41f5-aca9-79217ddfc6fb"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b6a40921-4f37-4be6-a9b8-14b0df286490"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
